...
public class DriverCodeLDLinkedList {
    /**
    ...
    public static void menu() throws Exception {
        ...
        StreetLDLinkedList street = new StreetLDLinkedList(lengthStreet);
    ...
    public static void driverFunction() throws Exception {
        StreetLDLinkedList testStreet = new StreetLDLinkedList(100);
