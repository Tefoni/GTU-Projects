...
public class StreetLDLinkedList {
    private LDLinkedList<Buildings> leftSide; // This data stored for the left side of the street

    private LDLinkedList<Buildings> rightSide; // This data stored for the right side of the street

    private int length; // Length of street(same on both sides of the street)

    public StreetLDLinkedList(int streetLength) throws Exception {
        if (streetLength <= 0)
            throw new Exception("Street length is not valid");

        leftSide = new LDLinkedList<Buildings>();
        rightSide = new LDLinkedList<Buildings>();
        length = streetLength;
    }
