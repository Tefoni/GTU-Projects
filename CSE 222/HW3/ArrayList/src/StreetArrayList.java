...
public class StreetArrayList {
    private ArrayList<Buildings> leftSide; // This data stored for the left side of the street

    private ArrayList<Buildings> rightSide; // This data stored for the right side of the street

    private int length; // Length of street(same on both sides of the street)

    public StreetArrayList(int streetLength) throws Exception {
        if (streetLength <= 0)
            throw new Exception("Street length is not valid");

        leftSide = new ArrayList<Buildings>(10);
        rightSide = new ArrayList<Buildings>(10); // Creating street with 10 building capacity
    ...
    public StreetArrayList() {
        leftSide = new ArrayList<Buildings>(10);
        rightSide = new ArrayList<Buildings>(10);
    ...
    public String buildingList() {
        ...
        for (int i = 0; i < rightSide.size(); i++) {
            buildList += rightSide.get(i).toString();
            buildList += "\n------------------------";
        }
